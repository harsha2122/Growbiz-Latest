...
class BecomeVendorController extends BaseController
{
    ...
    public function index()
    {
        ...
        if ($customer->is_vendor) {
            ...
            if (
                ...
                && (! $store->aadhar_file_1 || ! $store->business_doc_file)
            ) {
                $storeInfo = [
    ...
    public function update(BecomeVendorRequest $request)
    {
        ...
        && (! MarketplaceHelper::getSetting('requires_vendor_documentations_verification', true)
            || ($customer->store->aadhar_file_1 && $customer->store->business_doc_file)), 404);
        ...
        } elseif ($request->input('aadhar_upload_mode') === 'pdf') {
            $store->aadhar_file_2 = null;
        }
        ...
        if ($request->input('business_doc_type')) {
            $store->business_doc_type = $request->input('business_doc_type');
        }
    ...
    public function downloadDocument(Request $request)
    {
        ...
        $allowedTypes = ['aadhar_1', 'aadhar_2', 'business_doc'];
