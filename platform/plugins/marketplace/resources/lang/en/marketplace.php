...
return [
    ...
    'email' => [
        ...
        'verify_vendor_title' => 'Verify seller',
        'verify_vendor_description' => 'Send email to the admin when a seller registers',
        'pending_product_approval_title' => 'Pending product approval',
        'pending_product_approval_description' => 'Send email to the admin when a seller post their products',
        'vendor_account_approved_title' => 'Seller account approved',
        'vendor_account_approved_description' => 'Send email to seller when their account approved',
        'product_approved_title' => 'Product approved',
        'product_approved_description' => 'Send email to seller when their product approved',
        'withdrawal_approved_title' => 'Withdrawal approved',
        'withdrawal_approved_description' => 'Send email to seller when their withdrawal request approved',
        'vendor_account_rejected_title' => 'Seller account rejected',
        'vendor_account_rejected_description' => 'Send email to seller when their account rejected',
        'vendor_account_unblocked_title' => 'Seller account unblocked',
        'vendor_account_unblocked_description' => 'Send email to seller when their account unblocked',
        'vendor_account_blocked_title' => 'Seller account blocked',
        'vendor_account_blocked_description' => 'Send email to seller when their account blocked',
        'store_new_order_subject' => 'New order(s) at {{ site_title }}',
        'verify_vendor_subject' => 'New seller at {{ site_title }} needs to be verified',
        ...
        'welcome_vendor_title' => 'Welcome seller',
        'welcome_vendor_description' => 'Send email to seller after registered',
        ...
        'vendor_account_blocked_subject' => 'Your seller account at {{ site_title }} has been blocked',
        'vendor_account_unblocked_subject' => 'Your seller account at {{ site_title }} has been unblocked',
        'order_cancellation_to_vendor_title' => 'Order cancellation (will be sent to seller)',
        'order_cancellation_to_vendor_description' => 'Send to seller when customer cancels an order',
    ...
    'email_templates' => [
        ...
        'vendor_account_blocked_message' => 'Your seller account at {{ site_title }} has been <strong>blocked</strong> as of :block_date.',
        ...
        'vendor_account_unblocked_message' => 'We are pleased to inform you that your seller account at {{ site_title }} has been <strong>unblocked</strong> as of :unblock_date.',
        ...
        // Verify Vendor
        'verify_vendor_title' => 'Verify Seller',
        'verify_vendor_message' => 'You have a new seller that needs to be verified on :site_title!',
        'vendor_information' => 'Seller Information',
        ...
        'welcome_vendor_registration_complete' => 'Your seller registration has been successfully completed, and you\'re now part of our vibrant community of sellers.',
        'welcome_vendor_next_steps' => 'Here\'s what you can do next:',
        'welcome_vendor_step_login' => 'Log in to your seller account using your credentials.',
        ...
        'login_vendor_account_button' => 'Log in to your seller account',
    ...
    'settings' => [
        ...
        'check_valid_signature' => 'Check valid signature in seller\'s earnings',
        'verify_vendor' => 'Seller verification (Seller just can post their product listing after getting verified)',
        'verify_vendor_helper' => 'If enabled, the admin must verify the seller before they can post their product listing.',
        'requires_vendor_documentations_verification' => 'Requires seller documentations verification',
        'requires_vendor_documentations_verification_helper' => 'If enabled, sellers must upload their documentation files when applying to become a seller.',
        'hide_become_vendor_menu_in_customer_dashboard' => 'Hide become seller menu in customer dashboard',
        'hide_become_vendor_menu_in_customer_dashboard_description' => 'If enabled, the "Become a seller" menu will be hidden in the customer dashboard.',
        ...
        'enable_vendor_categories_filter' => 'Enable seller categories filter',
        'enable_vendor_categories_filter_description' => 'Show categories filter on seller store page. Only categories that have seller products will be displayed.',
        'allow_vendor_manage_shipping' => 'Allow seller manage shipping?',
        'allow_vendor_manage_shipping_description' => 'If it is enabled, the seller can change shipping status of order to "delivering", "delivered", ...',
        'charge_shipping_per_vendor' => 'Charge shipping per seller?',
        'charge_shipping_per_vendor_description' => 'If enabled, shipping will be charged separately for each seller. If disabled, shipping will be charged once for the entire order.',
        ...
        'enable_vendor_registration' => 'Enable seller registration',
        'enable_vendor_registration_helper' => 'If enabled, sellers can register an account on the site and post their products.',
        'minimum_withdrawal_amount' => 'Minimum withdrawal amount (Fixed)',
        'minimum_withdrawal_amount_helper' => 'Specify the minimum amount a seller can withdraw. Default is 0.',
        'allow_vendor_delete_their_orders' => 'Allow sellers to delete their orders',
        'allow_vendor_delete_their_orders_description' => 'When enabled, sellers can manage their order list by removing unwanted entries. Use with caution as deleted orders may impact transaction records.',
        'allow_vendor_manage_payment_status' => 'Allow sellers to manage payment status',
        'allow_vendor_manage_payment_status_description' => 'When enabled, sellers can confirm payment status for their orders in their dashboard.',
        'enable_messaging_system' => 'Enable messaging system',
        'enable_messaging_system_description' => 'If enabled, sellers and customers can communicate with each other via the messaging system.',
        'term_and_privacy_policy_url' => 'Term and privacy policy URL',
        'show_vendor_registration_form_at_registration_page' => 'Show seller registration form at registration page',
        'show_vendor_registration_form_at_registration_page_description' => 'If enabled, the seller registration form will be displayed on the registration page.',
        'single_vendor_checkout' => 'Limit to One Seller per Order',
        'single_vendor_checkout_help' => 'If enabled, customers can only purchase products from one seller per order.',
        ...
        'show_vendor_info_at_checkout' => 'Show seller information at checkout',
        'show_vendor_info_at_checkout_helper' => 'If enabled, seller information (name, logo, reviews) will be displayed on the checkout page.',
        'media_file_types_can_be_uploaded_by_vendor' => 'Media file types can be uploaded by seller',
        'media_file_types_can_be_uploaded_by_vendor_helper' => 'Specify the media file types that sellers can upload. Select them in the above list.',
    ...
    'theme_options' => [
        ...
        'logo_vendor_dashboard' => 'Logo in the seller dashboard (Default is the main logo)',
    ],
    ...
    'view_vendor' => 'View seller :name',
    'vendor_information' => 'Seller Information',
    'vendor_verified' => 'Seller Verified',
    'vendor_not_verified' => 'Seller Not Verified',
    'vendor_verified_at' => 'Seller Verified At',
    'vendor_type_service' => 'Service Provider',
    'vendor_type_products' => 'Product Seller',
    'vendor_type_both' => 'Service & Product Provider',
