                                ...
                                @else
                                    @if($store->aadhar_file_1)
                                        ...
                                        @else
                                            <div class="alert alert-warning small mb-2 p-2">
                                                ...
                                                Aadhaar Side 1: File missing on disk
                                                <br><small class="text-muted">Path: {{ $store->aadhar_file_1 }}</small>
                                            </div>
                                        @endif
                                    @endif
                                    ...
                                    @if($store->aadhar_file_2)
                                        ...
                                        @else
                                            <div class="alert alert-warning small mb-2 p-2">
                                                <x-core::icon name="ti ti-alert-triangle" />
                                                Aadhaar Side 2: File missing on disk
                                                <br><small class="text-muted">Path: {{ $store->aadhar_file_2 }}</small>
                                            </div>
                                        @endif
                                    @endif
                                    ...
                                    @if($store->business_doc_file)
                                        @php
                                            $docTypeLabel = match($store->business_doc_type) {
                                                'gst_certificate' => 'GST Certificate',
                                                'shop_act' => 'Shop Act',
                                                'udyam_aadhar' => 'Udyam Aadhaar',
                                        ...
                                        @else
                                            <div class="alert alert-warning small mb-2 p-2">
                                                <x-core::icon name="ti ti-alert-triangle" />
                                                {{ $docTypeLabel }}: File missing on disk
                                                <br><small class="text-muted">Path: {{ $store->business_doc_file }}</small>
                                            </div>
                                        @endif
                                    @endif
                                @endif
